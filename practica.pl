...
%    paraules.
%
% Per optimitzar el programa només comprovam que no estiguin repetides les
% paraules de la mateixa mida, ja que una paraula de 5 lletres mai serà la
% mateixa que una de 6.
